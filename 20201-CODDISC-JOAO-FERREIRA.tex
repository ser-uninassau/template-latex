...
\def\idcurso{99}
\def\curso{Nome do Curso Superior}

\def\iddisciplina{CODDISC}
...
\title[\iddisciplina]{\textbf{\curso}}

\subtitle{\iddisciplina~---~\disciplina}

\subject{\curso~---~\disciplina~---~\semestre}
...
\hypersetup{% http://www.tug.org/applications/hyperref/manual.html#x1-120003.8
  ...
  pdfauthor={\professor},                   % text for PDF Author field
  ...
  pdfproducer={\professor},                 % text for PDF Producer field
  % pdfstartpage=1,                           % page at which PDF document opens
  pdfsubject={\curso~--~\disciplina~--~\semestre},  % text for PDF Subject field
  pdftitle={\curso~--~\disciplina~--~\semestre},    % text for PDF Title field
}
\makeatother
% ------------------------------------------------------------------------------
...
{\usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{img/logo/background-amarelo.png}}
  \begin{frame}[plain]
...
{\usebackgroundtemplate{{\transparent{0.2}\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{img/logo/background-amarelo.png}}}
  \begin{frame}[plain,t]
    ...
    \begin{block}{}
      \centering{}
      \huge{\textbf{\MakeUppercase{\curso}}}
    \end{block}
    ...
    \begin{block}{}
      \centering{}
      \normalsize{\textbf{\MakeUppercase{\disciplina}}}

      \vspace*{1ex}

      \footnotesize{\MakeUppercase{\professor}}
    \end{block}
...
% ------------------------------------------------------------------------------
% ------------------------------------------------------------------------------
\include{20201-CODDISC-SEC01-PROFESSOR}

\include{20201-CODDISC-SEC02-PLANO-ENSINO}

\include{20201-CODDISC-SEC03-PLANEJAMENTO}

\include{20201-CODDISC-SEC04-INTRODUCAO}

\include{20201-CODDISC-SEC05-TEMA01}

\include{20201-CODDISC-SEC06-TEMA02}

\include{20201-CODDISC-SEC07-TEMA03}

\include{20201-CODDISC-SEC08-TEMA04}

\include{20201-CODDISC-SEC99-LISTA01}

\include{20201-CODDISC-SEC99-LISTA02}

\include{20201-CODDISC-SEC99-PROJETO01}

\include{20201-CODDISC-SEC99-PROJETO02}
...
{\usebackgroundtemplate{{\transparent{0.2}\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{img/logo/background-amarelo.png}}}
  \begin{frame}[plain,t]
    ...
    \addtobeamertemplate{block begin}{\pgfsetfillopacity{0.5}}{\pgfsetfillopacity{1}}
    \setbeamercolor{block title}{use=structure,fg=black,bg=blue}
    \setbeamercolor{block body}{use=structure,fg=black,bg=blue!50!white}
    \begin{block}{\textbf{\professor}}
      \justifying{}
      \begin{itemize}
        \justifying{}
...
% \begin{frame}[allowframebreaks,t]\frametitle{Referências ---}
\begin{frame}[t]\frametitle{Referências}
...
{\usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{img/logo/background-branco.png}}
  \begin{frame}[plain]
